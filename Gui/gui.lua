...
DefaultTitle=" | 666's Remote Spy",ContainerName='ReGui',DoubleClickThreshold=0.3,
...
aa:CheckConfig(self,{Toggle=t:RadioButton{LayoutOrder=1,Size=UDim2.new(0,0),Visible=false},CloseButton=t:RadioButton{LayoutOrder=3,Size=UDim2.new(0,0),Visible=false},TitleLabel=t:Label{ColorTag='Title',LayoutOrder=2,Size=UDim2.new(1,0),Active=false,Fill=true,ClipsDescendants=true,AutomaticSize=Enum.AutomaticSize.XY}})self:TagElements{[self.TitleLabel]='WindowTitle'}end function
